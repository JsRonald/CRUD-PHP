            ...
            <?php
              ...
              /* INCLUSÃO DO ARQUIVO QUE REALIZA A CONEXÃO COM O BANCO DE DADOS*/
               ...
               include 'restrito.php';
                ...
                $sql = "DELETE FROM pessoas WHERE cod_pessoas='$cod_pessoas'";
                ...
                if(mysqli_query($conexao, $sql))
                {
                    ...
                    mensagem("$nome Deletado com sucesso", 'success', 'feito.png');
                }
                else
                { 
                    /*FUNÇÃO CRIADA DENTRO DO ARQUIVO CONEXAO*/
                    mensagem("Não foi possivel deletar", 'danger', 'naofeito.jpg');
                }
            ?>
            <br>
