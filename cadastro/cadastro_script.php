            ...
            <?php
              ...
              /* INCLUSÃO DO ARQUIVO QUE REALIZA A CONEXÃO COM O BANCO DE DADOS*/
               ...
               include 'restrito.php';
                ...
                /* ATRIBUIÇÃO USANDO MIDIA*/

                $foto =$_FILES['foto'];

                /*COMO O TIPO FILE É UM VETOR BIDIMENSIONAL, VAMOS ATRIBUIR O NOME DO ARQUIVO PARA UMA VARIAVEL ESPECIFICA, PARA O BD*/
                ...
                $sql =  "INSERT INTO pessoas (nome, endereco, telefone, email, data_nascimento,foto) VALUES ('$nome', '$endereco', '$telefone', '$email', '$data_nascimento','$nomefoto')";

                if(mysqli_query($conexao, $sql))
                {
                    if($nomefoto != null){
             
                    echo "<img src='img/$nomefoto' title='$nomefoto' class='mostra_foto'>";
